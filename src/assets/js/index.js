...
// slider
const initSlider = () => {
  let slidesPerView = 3; // Задает количество отображаемых слайдов по умолчанию

  // Если ширина экрана меньше или равна 768px (ширина мобильных устройств), то устанавливаем slidesPerView: 1
